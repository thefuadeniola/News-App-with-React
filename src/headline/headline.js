...
export default function Headline(props) {
    ...
    return(
        <div className='headlines'>
            <Link to={{pathname: headliner.url}} style={{textDecoration:'none'}} target=''>
            ...
            {props.news.length > 1 && 
            <Link to={{pathname: headlinertwo.url}} style={{textDecoration:'none'}} target=''>
            ...
            {props.news.length >2 &&
            <Link to={{pathname: headlinerthree.url}} style={{textDecoration:'none'}} target=''>
